...
class Presets(object):
    ...
    WELCOME_TEXT = "Hello.. <b>{}</b>\n<code>I can help you getting movies from</code> @CFCHART . " \
                   "<code>Just Keep this message live Here</code>😉\n\n<b>My Author is: " \
                   "</b><a href='https://t.me/CFCHART'>                 HERE</a>\n" \
